...
class _UploadBrandsScreenState extends State<UploadBrandsScreen> {
  ...
  final TextEditingController brandInfoTextEditingController =
      TextEditingController();
  final TextEditingController brandTitleTextEditingController =
      TextEditingController();

  bool upLoading = false;
  String downloadUrlImage = "";
  String brandUniqId = DateTime.now().millisecondsSinceEpoch.toString();

  bool get isFormValid {
    return selectedImage != null &&
        brandInfoTextEditingController.text.trim().isNotEmpty &&
        brandTitleTextEditingController.text.trim().isNotEmpty;
  }
  ...
  Future<void> saveBrandInfoToFirestore() async {
    ...
    setState(() {
      brandInfoTextEditingController.clear();
      brandTitleTextEditingController.clear();
      selectedImage = null;
      upLoading = false;
      brandUniqId = DateTime.now().millisecondsSinceEpoch.toString();
    });
